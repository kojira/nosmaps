  ...
  const dictionaries = {
    ja: {
      ...
      concepts: {
        ...
        search: 'キーワード検索', searchPlaceholder: '名前・特徴で検索', categoryFilter: 'カテゴリで絞り込む', status: '状態', platform: '環境', sort: '並び順', name: '名前',
      ...
      explorer: {
        ...
        search: 'アプリ／サービスを全文検索', searchPlaceholder: '名称・概要・カテゴリ・OS・提供形態・別名', featureGroup: '主要機能（複数選択・AND条件）', categoryGroup: 'カテゴリで絞り込む',
