  ...
  const dictionaries = {
    ja: {
      ...
      landing: {
        ...
        sampleNotice: 'ここに並ぶのは同梱データのサンプル項目です。人気や順位を表すものではありません。',
      ...
      explorer: {
        ...
        sampleData: 'サンプル', relayVerified: 'リレー検証済み', relayEmptyTitle: '該当レコードなし', relayEmpty: '設定したリレーでは、該当トピックを付けた kind 32267 レコードを観測できませんでした。存在しないという意味ではありません。',
    ...
    en: {
      ...
      landing: {
        ...
        sampleNotice: 'The entries below are sample records from the bundled sample data. They are not a ranking or a popularity signal.',
